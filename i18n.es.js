window.BOOKQUEST_I18N_ES = {
    ...
    aiStatusReady: "IA lista.",
    aiStatusUnavailable: "WebGPU no disponible.",
    aiStatusDisabled: "IA desactivada.",
    aiStatusDownloading: "Descargando modelo... {pct}%",
    aiStatusOffline: "Sin conexion. Usando misiones fallback.",
    aiStatusIdle: "Listo para descargar cuando se necesite.",
