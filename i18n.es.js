window.BOOKQUEST_I18N_ES = {
    ...
    aiTitle: "IA en el dispositivo",
    aiToggleLabel: "Generar misiones con IA local (descarga ~290 MB)",
    aiClearModel: "Borrar modelo descargado",
    aiClearHint: "Borra los archivos de IA local (puede requerir recargar).",
    aiReload: "Recargar",
